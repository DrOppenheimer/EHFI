...
echo "render_pcoa.v3( PCoA_in = \"$1\", amethst_groups = \"$2\", image_width_in = $3, image_height_in = $4, image_res_dpi = $5, width_legend = $6, width_figure = $7, legend_cex = $8, figure_cex = $9 )" >> my_script.$time_stamp.$process_stamp.r
