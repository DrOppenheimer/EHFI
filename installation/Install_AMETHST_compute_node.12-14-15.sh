...
# Make sure KB_AUTH_TOKEN and AWE_CLIENT_GROUP_TOKEN have valid values then:original_path
...
## Please contact Qiime developers if you run into problems with Qiime installation
## and/or operation
